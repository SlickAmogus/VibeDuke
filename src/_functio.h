...
#ifdef _XBOX
/* Xbox OG controller button defaults (indexed by SDL_CONTROLLER_BUTTON_*) */
...
static char * joystickclickeddefaults_xbox[MAXJOYBUTTONS] =
   {
   "", "", "", "", "", "", "", "",
   "", "", "", "", "", "", "", "",
   "", "", "", "", "", "", "", "",
...
/* Xbox analog axis mapping (joyaxis[] indices after sdlayer2.c remapping):
 *   0=LeftX  1=LeftY  2=RightX  3=RightY  4=LTrigger  5=RTrigger */
static char * joystickanalogdefaults_xbox[MAXJOYAXES] =
   {
   "analog_strafing",            // 0: Left stick X
   "analog_moving",              // 1: Left stick Y
   "analog_turning",             // 2: Right stick X
   "analog_lookingupanddown",    // 3: Right stick Y
   "",                           // 4: Left trigger
   "",                           // 5: Right trigger
   "", "", "", "", "", "",
   };

/* Xbox digital axis defaults (2 entries per axis: [min, max]):
 *   Axis 4 max = LT pulled = Run,  Axis 5 max = RT pulled = Fire */
static char * joystickdigitaldefaults_xbox[MAXJOYAXES*2] =
   {
   "", "",    // Axis 0: Left stick X
   "", "",    // Axis 1: Left stick Y
   "", "",    // Axis 2: Right stick X
   "", "",    // Axis 3: Right stick Y
   "", "Run", // Axis 4: Left trigger (min, max)
   "", "Fire",// Axis 5: Right trigger (min, max)
   "", "", "", "", "", "", "", "", "", "", "", "",
   };
#endif
