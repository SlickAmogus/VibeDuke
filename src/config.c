...
#ifdef _XBOX
    CONFIG_SetJoystickDefaults(2);  // Xbox OG controller layout
#else
...
#ifdef _XBOX
    if (style == 2) {
        joydefaultset = joystickdefaults_xbox;
        joyclickeddefaultset = joystickclickeddefaults_xbox;
        joydigitaldefaultset = joystickdigitaldefaults_xbox;
        joyanalogdefaultset = joystickanalogdefaults_xbox;
    } else
#endif
    if (style) {
