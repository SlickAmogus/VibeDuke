...
static int loadpalette(void)
{
...
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: kopen4load\n"); }
#endif
	if ((fil = kopen4load("palette.dat",0)) < 0) goto badpalette;
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: kfilelength\n"); }
#endif
	flen = kfilelength(fil);
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: flen=%ld\n", (long)flen); }
#endif
...
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: palette read ok\n"); }
#endif

	if ((flen - 65536 - 2 - 768) % 256 == 0) {
		// Map format 7+ palette.
#ifdef _XBOX
		{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: format7+\n"); }
#endif
...
#ifdef _XBOX
		{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: old fmt, shades=%d\n", numpalookups); }
#endif
...
#ifdef _XBOX
		{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: damaged! flen=%ld\n", (long)flen); }
#endif
		goto badpalette;
	}
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: numpalookups=%d\n", numpalookups); }
#endif
...
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: palookup alloc ok\n"); }
#endif
...
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: transluc alloc ok\n"); }
#endif

	globalpalwritten = palookup[0]; globalpal = 0;
	setpalookupaddress(globalpalwritten);
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: setpalookupaddress done\n"); }
#endif
	fixtransluscence(transluc);
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: fixtransluscence done\n"); }
#endif
	...
	if (fil >= 0) {
		...
		kclose(fil);
#ifdef _XBOX
		{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: kread shades done\n"); }
#endif
	}

#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("LP: initfastcolorlookup\n"); }
#endif
...
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("DUKE3D: loadtables\n"); }
#endif
	if (loadtables()) return 1;
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("DUKE3D: loadpalette\n"); }
#endif
	if (loadpalette()) {
#ifdef _XBOX
		{ extern void xbox_log(const char *fmt, ...); xbox_log("DUKE3D: loadpalette FAILED: %s\n", engineerrstr ? engineerrstr : "?"); }
#endif
		return 1;
	}
#ifdef _XBOX
	{ extern void xbox_log(const char *fmt, ...); xbox_log("DUKE3D: loadpalette done\n"); }
#endif
...
int setgamemode(int dafullscreen, int daxdim, int daydim, int dabpp)
{
	...
	if (setvideomode(daxdim,daydim,dabpp,dafullscreen) < 0) {
#ifdef _XBOX
		xbox_log("XBOX: setvideomode(%d,%d,%d,%d) FAILED\n", daxdim, daydim, dabpp, dafullscreen);
#endif
		return(-1);
	}
	...
	xdim = xres; ydim = yres;
#ifdef _XBOX
	xbox_log("XBOX: setgamemode done: xdim=%d ydim=%d xres=%d yres=%d\n", xdim, ydim, xres, yres);
#endif
